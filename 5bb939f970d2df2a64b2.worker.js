...
/***/ "./node_modules/ts-loader/index.js!./src/wallet/workers/WorkerCoins.ts":
/*!********************************************************************!*\
  !*** ./node_modules/ts-loader!./src/wallet/workers/WorkerCoins.ts ***!
  \********************************************************************/
/*! no exports provided */
...
/* harmony import */ var _requests_get_claimable_by_input_owner__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../requests/get-claimable-by-input-owner */ "./src/wallet/requests/get-claimable-by-input-owner.ts");

// unoptimized
const ctx = self;
ctx.addEventListener('message', (message) => syncWorkers(message.data[0], message.data[1]));
async function syncWorkers(coins, config) {
    for (const coin of coins) {
        const claimable = await Object(_requests_get_claimable_by_input_owner__WEBPACK_IMPORTED_MODULE_0__["default"])(config, coin.owner);
        if (!claimable) {
            continue;
        }
...
/***/ "./src/wallet/requests/get-claimable-by-input-owner.ts":
/*!*************************************************************!*\
  !*** ./src/wallet/requests/get-claimable-by-input-owner.ts ***!
  \*************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getClaimableByInputOwner; });
...
async function getClaimableByInputOwner(config, inputOwnerStr) {
    const url = `${config.custodianUrl}/claimable-by-input-owner/${inputOwnerStr}`;
    const claimablePOD = await Object(_make_request__WEBPACK_IMPORTED_MODULE_1__["default"])(url);
    if (claimablePOD instanceof _make_request__WEBPACK_IMPORTED_MODULE_1__["RequestError"]) {
        throw claimablePOD;
    }
    if (!claimablePOD) {
        return undefined;
    }
    const ackdClaimable = moneypot_lib__WEBPACK_IMPORTED_MODULE_0__["Acknowledged"].claimableFromPOD(claimablePOD);
    ...
    if (!(claimable instanceof moneypot_lib__WEBPACK_IMPORTED_MODULE_0__["AbstractTransfer"])) {
...
/******/ });
//# sourceMappingURL=5bb939f970d2df2a64b2.worker.js.map